"""
Django settings for black_recipe_47696 project.
...
ROOT_URLCONF = 'black_recipe_47696.urls'
...
WSGI_APPLICATION = 'black_recipe_47696.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_recipe_47696 API",
    "DESCRIPTION": "API documentation for black_recipe_47696 App",
    "VERSION": "v1",
}
